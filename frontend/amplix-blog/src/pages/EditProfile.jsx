        ...
        <main className="max-w-xl mx-auto">
          ...
          <div
            style={{
              ...
              display: "flex",
              gap: "12px",
              backgroundColor: "***REMOVED***e0f2fe",
              borderLeft: "4px solid ***REMOVED***0284c7",
          ...
          >
            <span
              ...
              style={{ color: "***REMOVED***0284c7", fontSize: "20px", marginTop: "2px", flexShrink: 0 }}
            >
              info
            </span>
            <div>
              <p style={{ fontSize: "14px", fontWeight: 700, color: "***REMOVED***0369a1", margin: 0 }}>
                Privacidad del Perfil
              </p>
              <p
                style={{ fontSize: "14px", color: "***REMOVED***475569", marginTop: "4px", lineHeight: "1.5" }}
              >
