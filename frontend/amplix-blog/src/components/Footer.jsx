    ...
    <footer className="border-t border-gray-200 bg-white px-6 py-8 mt-auto">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-md text-gray-500 font-medium">
          <a href="***REMOVED***" className="hover:text-blue-700 transition">
            Privacy Policy
          </a>
          <a href="***REMOVED***" className="hover:text-blue-700 transition">
            Terms of Service
        ...
        <div className="flex items-center gap-2">
          <button
            className="w-8 h-8 rounded-full cursor-pointer border border-gray-300 bg-gray-200 flex items-center justify-center text-gray-900 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition"
